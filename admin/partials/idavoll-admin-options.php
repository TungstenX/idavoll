    		...
    		<td>
		        <fieldset>
		            ...
		            <label for="<?php echo $this->plugin_name; ?>-cancellationdays">        	
		                <input type="number" step='1' value='<?php if(!empty($cancellationdays)) {echo $cancellationdays;} else {echo "14";} ?>' placeholder='14'  id="<?php echo $this->plugin_name; ?>-cancellationdays" name="<?php echo $this->plugin_name; ?>[cancellationdays]" /> days                
		            </label>
		        </fieldset>
		    </td>
		</tr>
