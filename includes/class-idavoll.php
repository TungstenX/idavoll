...
class Idavoll {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Idavoll_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Idavoll_Loader. Orchestrates the hooks of the plugin.
	 * - Idavoll_i18n. Defines internationalization functionality.
	 * - Idavoll_Admin. Defines all hooks for the admin area.
	 * - Idavoll_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-idavoll-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-idavoll-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-idavoll-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-idavoll-public.php';

		$this->loader = new Idavoll_Loader();
	 ...
	 *
	 * Uses the Idavoll_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Idavoll_Admin( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Idavoll_Loader    Orchestrates the hooks of the plugin.
	 */
